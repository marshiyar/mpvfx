...
export const FIELD =
  "min-w-0 rounded-md bg-panel-input px-3 py-[7px] text-panel-text-1 transition-colors focus-within:outline focus-within:outline-1 focus-within:outline-panel-accent/30";
