...
describe("resolveDomEditSelection", () => {
  ...
  it("does not throw when a generated timeline identity is passed as a selector", () => {
    ...
    expect(() =>
      findElementForSelection(
        document,
        {
          id: "index.html:MpVFX Logo Light:0",
          selector:
            '[data-composition-id="index.html:MpVFX Logo Light:0"],#index.html:MpVFX Logo Light:0',
  ...
  it("resolves generated timeline ids without throwing", () => {
    ...
    expect(
      findElementForTimelineElement(
        document,
        { id: "index.html:MpVFX Logo Light:0", sourceFile: "index.html" },
        {
          activeCompositionPath: null,
          isMasterView: true,
        },
  ...
  it("falls back to the root composition for standalone manifest clips without DOM targets", () => {
    ...
    expect(
      findElementForTimelineElement(
        document,
        { id: "compositions/hook.html:MpVFX Logo Light:0" },
        {
