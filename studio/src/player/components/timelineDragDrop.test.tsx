...
describe("useTimelineAssetDrop", () => {
  ...
  it("falls through a malformed asset payload to a valid block payload", () => {
    ...
    const firstRowMiddleY =
      view.geometry.getRowTop(0) + view.geometry.getRowHeight(0) / 2;

    act(() => {
      view.api.handleAssetDragOver(dragEvent(transfer, 400, firstRowMiddleY));
      view.api.handleAssetDrop(dragEvent(transfer, 400, firstRowMiddleY));
    });
