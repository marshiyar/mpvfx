...
describe("computeResizePreview — composition source continuity", () => {
  it("preserves the native rational-frame boundary through the real trim preview seam", () => {
    ...
    const element = {
      ...clip("native-video", 0, secondsAtFrame(30), secondsAtFrame(120), 0, "video"),
    ...
    expect(result).toMatchObject({
      previewStart: secondsAtFrame(45),
      previewDuration: secondsAtFrame(105),
      previewPlaybackStart: secondsAtFrame(40),
    });
  });
