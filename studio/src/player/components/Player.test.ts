...
class TestMpVfxPlayer extends HTMLElement {
...
if (!customElements.get("hyperframes-player")) {
  customElements.define("hyperframes-player", TestMpVfxPlayer);
}
...
async function mountPlayer() {
  ...
  const player = host.querySelector<TestMpVfxPlayer>("hyperframes-player");
