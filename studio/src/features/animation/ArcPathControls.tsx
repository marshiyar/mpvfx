...
import { SliderControl } from "../inspector/propertyPanelPrimitives";
import { LABEL } from "../inspector/propertyPanelHelpers";
import { P } from "../inspector/panelTokens";
          ...
          {arcPath.segments.map((seg, i) => (
            <div key={i} className="grid min-w-0 gap-1.5">
              ...
              <SliderControl
                ...
                onReset={() => onUpdateSegment(i, { curviness: 1 })}
