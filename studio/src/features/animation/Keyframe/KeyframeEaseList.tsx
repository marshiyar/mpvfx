...
import { EASE_LABELS } from "../GSAP/gsapAnimationConstants";
      ...
      <div className="flex items-center gap-2">
        ...
        {onApplyAll && (
          <select
            ...
            className="ml-auto cursor-pointer rounded bg-neutral-800 px-1.5 py-0.5 text-[9px] text-neutral-300 outline-none hover:bg-neutral-700 focus:outline focus:outline-1 focus:outline-panel-accent/40"
          >
        ...
        return (
          ...
          >
            <button
              ...
              aria-label={`Edit easing for segment ${keyframes[i - 1].percentage}% to ${kf.percentage}%, ending at ${kf.percentage}% keyframe`}
