...
import { setElementGsapPosition } from "../../canvas/elementGsap";
import { logResize, logResizeSettle } from "../../../lib/resizeDebug";
import type { DomEditGroupPathOffsetCommit } from "../../canvas/DomEditOverlay";
