...
import { clearStudioBoxSize } from "../../canvas/manualEdits";
import {
  STUDIO_ORIGINAL_BOX_HEIGHT_ATTR,
  STUDIO_ORIGINAL_BOX_WIDTH_ATTR,
} from "../../canvas/manualEditsTypes";
import { setElementGsapPosition, setElementGsapScale } from "../../canvas/elementGsap";
...
import { logResize } from "../../../lib/resizeDebug";
import {
