...
import { readProjectFileContent as readSharedProjectFileContent } from "../../history/studioFileHistory";
import type { DomEditSelection } from "../../canvas/domEditingTypes";
import { usePlayerStore } from "../../../player/store/playerStore";
import { applySoftReload, extractGsapScriptText } from "../../legacy/gsapSoftReload";
import type { SoftReloadResult } from "../../legacy/gsapSoftReload";
...
function syncCommittedGsapMutation({
  ...
  // final write renders. Only the preview work belongs to the deferred path.
  if (options.skipReload) return;
