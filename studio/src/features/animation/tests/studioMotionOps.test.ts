...
import { buildMotionPatches, buildClearMotionPatches } from "../../canvas/manualEditsDomPatches";
import { applyPatchByTarget, readAttributeByTarget } from "../../legacy/sourcePatcher";
