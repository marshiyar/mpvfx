...
import { markStudioWriteToken, STUDIO_WRITE_TOKEN_HEADER } from "../history/studioFileVersion";
...
async function requestAtomicCut(
  ...
  const response = await desktopRequest(buildProjectApiPath(projectId, "/file-mutations/split-batch"), {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      [STUDIO_WRITE_TOKEN_HEADER]: transactionToken,
    },
