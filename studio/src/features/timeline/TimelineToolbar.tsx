...
import {
  ...
  type NudgeSelectedKeyframesSession,
} from "../animation/Keyframe/nudgeSelectedKeyframes";
import {
...
export function TimelineToolbar({
  ...
  const onNudgeSelectedKeyframe = useCallback(
    (direction: -1 | 1, large: boolean) => {
      if (!domEditSession || !canNudgeSelectedKeyframes) return;
      void nudgeSelectedKeyframes(
        {
          ...domEditSession,
          handleGsapMoveKeyframes: domEditSession.handleGsapMoveKeyframes,
        },
        direction,
        large,
      );
    },
    [canNudgeSelectedKeyframes, domEditSession],
  );
    ...
    <div className="border-b border-neutral-800/60">
      <div className="flex items-center justify-between px-2 py-0.5">
        ...
        <div className="flex items-center gap-0.5">
          ...
          {/* Keep the numeric scale visible in both fit and manual modes. */}
          <span
