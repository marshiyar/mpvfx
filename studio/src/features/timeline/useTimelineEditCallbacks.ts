...
import { resolveClipTimingBasis } from "../animation/GSAP/useGsapTweenCache";
import {
  isRenderedKeyframeIdentityMatch,
  keyframeIsAtOutputTime,
} from "../animation/GSAP/gsapShared";
import { elementCacheKeys } from "../animation/GSAP/gsapKeyframeCacheHelpers";
import { resolveKeyframeRetime } from "../animation/Keyframe/keyframeRetime";
import type { DomEditSelection } from "../canvas/domEditingTypes";
import { valuesAt } from "../../player/components/trackHeaderLaneValues";
import type { TimelineMoveOperation } from "./timelineMoveAdapter";
import {
