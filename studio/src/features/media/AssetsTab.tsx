...
import { MEDIA_EXT, FONT_EXT } from "./mediaTypes";
import { buildProjectApiPath } from "../../app/projectRouting";
import { copyTextToClipboard } from "../canvas/clipboard";
...
export const AssetsTab = memo(function AssetsTab({
  ...
  useEffect(() => {
    ...
    let cancelled = false;
    desktopRequest(buildProjectApiPath(projectId, "/preview/.media/manifest.jsonl"))
      .then((r) => {
        if (!r.ok) {
