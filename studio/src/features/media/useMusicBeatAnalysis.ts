...
import { resolveBeatSourceTrack } from "../timeline/timelineInspector";
...
import { mergeUserBeats } from "./beatEditing";
import { getTimelineElementIndexes } from "../../player/lib/timelineElementIndexes";
import { remapBeatAnalysisToComposition } from "./beatEditActions";
import {
  audioRelPathForSrc,
  beatFilePathForSrc,
  serializeBeats,
