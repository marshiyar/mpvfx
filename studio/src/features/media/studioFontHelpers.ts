import { googleFontStylesheetUrl } from "../inspector/fontCatalog";
import { importedFontFaceCss, type ImportedFontAsset } from "../inspector/fontAssets";
import { toRelativeProjectAssetPath } from "../../lib/studioHelpers";
