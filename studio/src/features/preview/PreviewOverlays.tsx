...
} from "../canvas/DomEditContext";
import { readStudioUiPreferences } from "../../app/studioUiPreferences";
import { readHfId, type DomEditSelection } from "../canvas/domEditing";
import { buildStableSelector } from "../canvas/domEditingDom";
import { deriveTimelineStoreKey } from "../../player/lib/timelineElementHelpers";
import { zReorderCoalesceKey } from "../canvas/useElementLifecycleOps";
import { useCanvasZOrderTimelineMirror } from "../canvas/useCanvasZOrderTimelineMirror";
import { runZLaneGesture } from "../timeline/zLaneGesture";
import type { BlockPreviewInfo } from "../media/BlocksTab";
import type { GestureRecordingState } from "../canvas/GestureRecordControl";
import type { ReactNode } from "react";
import {
  parseInsetClipPathSides,
  selectionIdentityKey,
} from "../inspector/propertyPanelHelpers";
import { useCropToolStore } from "../canvas/cropToolStore";
import { useNLEContext } from "./NLEContext";
import type { PreviewMouseDownOptions } from "./usePreviewInteraction";
...
export function PreviewOverlays({
  ...
  const { play, pause } = useNLEContext();
  ...
  const handleCanvasMouseDown = useCallback(
    (event: React.MouseEvent<HTMLDivElement>, options?: PreviewMouseDownOptions) =>
      handlePreviewCanvasMouseDown(event, { ...options, playback: { pause, play } }),
    [handlePreviewCanvasMouseDown, pause, play],
  );
