...
import { PlayerControls } from "../../player/index";
...
export function PreviewPane({
  ...
  const studioShell = useStudioShellContextOptional();
  const {
    projectId,
    iframeRef,
    togglePlay,
      ...
      <div className="flex-shrink-0">
        ...
        <PlayerControls
          ...
          historyActions={
            studioShell
              ? {
                  canUndo: studioShell.editHistory.canUndo,
                  canRedo: studioShell.editHistory.canRedo,
                  undoLabel: studioShell.editHistory.undoLabel,
                  redoLabel: studioShell.editHistory.redoLabel,
                  onUndo: studioShell.handleUndo,
                  onRedo: studioShell.handleRedo,
                }
              : undefined
          }
        />
