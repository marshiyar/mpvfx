import type { DomEditViewport } from "../canvas/domEditing";
import {
  getDomLayerPatchTarget,
  isElementComputedVisible,
  resolveAllVisualDomEditTargets,
} from "../canvas/domEditingElement";
import { isHtmlElement } from "../canvas/domEditingDom";
import { getEventTargetElement } from "../../lib/studioHelpers";
...
// instead of grabbing the giant container. Their timeline strips still select them.
