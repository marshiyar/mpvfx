...
} from "../canvas/manualEdits";
import { STUDIO_MOTION_PATH } from "../animation/studioMotion";
import type { EditHistoryKind } from "../history/editHistory";
import { createDomEditSaveQueue, type DomEditSaveDrainResult } from "../history/domEditSaveQueue";
import {
...
import { applyUndoRestoreToPreview, type UndoRestoreFile } from "../legacy/gsapUndoRestore";
