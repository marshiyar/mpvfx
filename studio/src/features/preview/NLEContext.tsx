...
import { useTimelinePlayer, usePlayerStore } from "../../player/index";
...
import { MIN_TIMELINE_H, fitTimelineHeight } from "../../app/fitPanels";
import { setCompositionSourceMap } from "../canvas/domEditingDom";
import { ensureMotionPathPluginLoaded } from "../legacy/gsapSoftReload";
...
import { createStableContext } from "../../app/hmrStableContext";
...
export function NLEProvider({
  ...
  useEffect(() => {
    ...
    desktopRequest(`/api/projects/${projectId}/files/index.html`, {
