...
import { useBlockCatalog } from "../media/useBlockCatalog";
      ...
      {overlays.map((overlay) => (
        ...
        >
          <span className="relative flex aspect-video w-full items-center justify-center overflow-hidden bg-black/20">
            ...
            <Plus
              size={12}
              className="absolute right-1.5 top-1.5 rounded-sm bg-black/70 px-0.5 text-white opacity-70 group-hover:text-panel-accent group-hover:opacity-100"
            />
          </span>
