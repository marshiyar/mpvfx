...
export function FlatMediaSection({
  ...
  /** Retained for compatibility with callers that share the legacy media props. */
      ...
      {(isVideo || isAudio) && (
        <>
          ...
          <FlatSlider
            ...
            formatValue={(next) => `${formatNumericValue(next / 100)}x`}
          ...
          <FlatSlider
            ...
            formatValue={(next) => formatTimingValue(next / 100)}
