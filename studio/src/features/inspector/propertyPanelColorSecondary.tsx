...
export function PropertyPanelColorSecondary({
  ...
  onPreview?: (secondaries: Secondaries) => void;
  onPreviewEnd?: () => void;
}) {
  ...
  const previewSelected = (next: NormalizedHfColorGradingSecondary) => {
    if (!selected) return;
    onPreview?.(secondaries.map((secondary, index) => (index === activeIndex ? next : secondary)));
  };
  const addSecondary = () => {
      ...
      {!selected ? (
        ...
        <>
          <FlatToggle
            ...
            tier={selected.enabled === DEFAULT_SECONDARY.enabled ? "default" : "explicitCustom"}
            onChange={(enabled) => replaceSelected({ ...selected, enabled })}
            onReset={() => replaceSelected({ ...selected, enabled: DEFAULT_SECONDARY.enabled })}
          />
          <button
            type="button"
            disabled={sampling}
          ...
          <FlatSlider
            ...
            step={0.1}
            tier={
              Math.abs(selected.key.hue.center - DEFAULT_SECONDARY.key.hue.center) > 0.0001
                ? "explicitCustom"
                : "default"
            }
            ...
            onReset={() =>
              replaceSelected({
                ...
                key: {
                  ...selected.key,
                  hue: { ...selected.key.hue, center: DEFAULT_SECONDARY.key.hue.center },
                },
              })
            }
          />
          <FlatSlider
            ...
            tier={
              Math.abs(selected.key.hue.range - DEFAULT_SECONDARY.key.hue.range) > 0.0001
                ? "explicitCustom"
                : "default"
            }
            ...
            onReset={() => {
              const range = DEFAULT_SECONDARY.key.hue.range;
              replaceSelected({
                ...selected,
                key: {
                  ...selected.key,
          ...
          <FlatSlider
            ...
            tier={
              Math.abs(selected.key.hue.softness - DEFAULT_SECONDARY.key.hue.softness) > 0.0001
                ? "explicitCustom"
                : "default"
            }
            ...
            onReset={() =>
              replaceSelected({
                ...
                key: {
                  ...selected.key,
                  hue: { ...selected.key.hue, softness: DEFAULT_SECONDARY.key.hue.softness },
                },
              })
            }
          />
          {(["saturation", "luma"] as const).flatMap((key) => {
            ...
            return [
              <FlatSlider
                ...
                tier={
                  Math.abs(range.min - DEFAULT_SECONDARY.key[key].min) > 0.0001
                    ? "explicitCustom"
                    : "default"
                }
                displayValue={percent(range.min)}
                formatValue={(next) => percent(next / PERCENT_SCALE)}
                onPreview={(value) =>
                  previewSelected({
                    ...selected,
                    key: {
                ...
                onReset={() =>
                  replaceSelected({
                    ...
                    key: {
                      ...selected.key,
                      [key]: { ...range, min: DEFAULT_SECONDARY.key[key].min },
                    },
                  })
                }
              />,
              <FlatSlider
                ...
                tier={
                  Math.abs(range.max - DEFAULT_SECONDARY.key[key].max) > 0.0001
                    ? "explicitCustom"
                    : "default"
                }
                ...
                onReset={() =>
                  replaceSelected({
                    ...
                    key: {
                      ...selected.key,
                      [key]: { ...range, max: DEFAULT_SECONDARY.key[key].max },
                    },
                  })
                }
              />,
              <FlatSlider
                ...
                tier={
                  Math.abs(range.softness - DEFAULT_SECONDARY.key[key].softness) > 0.0001
                    ? "explicitCustom"
                    : "default"
                }
                ...
                onReset={() =>
                  replaceSelected({
                    ...
                    key: {
                      ...selected.key,
                      [key]: { ...range, softness: DEFAULT_SECONDARY.key[key].softness },
                    },
                  })
                }
              />,
          ...
          {CORRECTION_CONTROLS.map(([key, label, scale, suffix]) => {
            ...
            return (
              <FlatSlider
                ...
                formatValue={(next) => `${Math.round(next)}${suffix}`}
                onPreview={(next) =>
                  previewSelected({
                    ...selected,
