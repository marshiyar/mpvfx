...
import { isTextEditableSelection, type DomEditSelection } from "../canvas/domEditing";
import {
...
export function StyleSections({
  ...
  const showMaskControls = !["video", "img"].includes(element.tagName.toLowerCase());
    ...
    <>
          ...
          <div className={RESPONSIVE_GRID}>
            <div className="grid min-w-0 gap-1.5">
              ...
              <SliderControl
                ...
                onReset={() =>
                  onSetStyle("filter", setCssFilterFunctionPx(styles.filter, "blur", 0))
                }
                onCommit={(next) =>
      ...
      <Section title="Clip" icon={<Layers size={15} />} defaultCollapsed>
        <div className="space-y-4">
          ...
          {showMaskControls && (
            <div className="grid min-w-0 gap-1.5">
              ...
              <SliderControl
                ...
                formatDisplayValue={(next) => `${formatNumericValue(next)}px`}
                onReset={() =>
                  onSetStyle("clip-path", buildInsetClipPathValue(0, radiusValue))
                }
                onCommit={(next) =>
          ...
          {showMaskControls && showClipInsetSides && (
