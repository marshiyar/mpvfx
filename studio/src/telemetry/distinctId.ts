...
//   - `mpvfx:anonymousId` (telemetry/config.ts → studio_* + render events)
...
export const DISTINCT_ID_KEY = "mpvfx:anonymousId";
 ...
 * means "this editor was launched by a compatible render CLI; adopt its identity".
 */
