        ...
        return group.segmentIds.map((segId) => {
          ...
          return (
            <div
              ...
              className={`absolute top-1 bottom-1 rounded flex items-center overflow-hidden cursor-pointer outline-none focus-visible:outline focus-visible:outline-1 focus-visible:outline-white${
                isSelected ? " outline outline-1 outline-white/50 z-10" : ""
              }`}
              style={{
                left,
                width,
