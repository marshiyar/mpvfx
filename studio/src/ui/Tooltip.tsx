...
import { clampCentredLeft } from "../features/inspector/floatingPanel";
        ...
        createPortal(
          ...
          >
            <div
              ...
              role="tooltip"
              id={tooltipId}
              className="px-2 py-1 rounded-md bg-neutral-800 border border-neutral-700/50 text-[10px] font-medium text-neutral-200 whitespace-nowrap"
            >
              {label}
            </div>
          </div>,
