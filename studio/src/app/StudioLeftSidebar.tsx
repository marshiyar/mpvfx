...
import { LeftSidebar, type LeftSidebarHandle } from "../features/media/LeftSidebar";
import { usePanelLayoutContext } from "./PanelLayoutContext";
import { useStudioShellContext } from "./StudioContext";
...
} from "../features/export/renderSettings";
import type { BlockPreviewInfo } from "../features/media/BlocksTab";
import { readAuthoredExportDimensions } from "../../shared/export/exportPolicy";
    ...
    async (comp: string) => {
      ...
      if (
        ...
        try {
          ...
          const authoredDimensions = readAuthoredExportDimensions(
            payload.content,
            parseSourceDocument,
          );
