...
vi.mock("../../features/timeline/useTimelineSelectionPreviewSync", () => hookMocks);
...
vi.mock("../../features/preview/NLEContext", () => ({
...
vi.mock("../../features/timeline/useTimelineEditCallbacks", () => ({
  useTimelineEditCallbacks: () => ({}),
}));
vi.mock("../../features/preview/PreviewPane", () => ({ PreviewPane: () => null }));
vi.mock("../../features/preview/PreviewOverlays", () => ({ PreviewOverlays: () => null }));
vi.mock("../../features/timeline/TimelinePane", () => ({ TimelinePane: () => null }));
