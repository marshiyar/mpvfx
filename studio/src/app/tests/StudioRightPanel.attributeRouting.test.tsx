...
vi.mock("../../features/inspector/PropertyPanel", () => ({
...
vi.mock("../../features/inspector/BlockParamsPanel", () => ({ BlockParamsPanel: () => null }));
vi.mock("../../features/export/RenderQueuePanel", () => ({ RenderQueuePanel: () => null }));
...
vi.mock("../../features/history/FileManagerContext", () => ({
